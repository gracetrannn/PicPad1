...
public struct MLLine: Codable {
    ...
    public internal(set) var hardness: CGFloat

    // optional color, color of line strip will be used if this sets to nil
    public internal(set) var color: MLColor?
    
    public init(begin: CGPoint, end: CGPoint, pointSize: CGFloat, pointStep: CGFloat, hardness: CGFloat, color: MLColor?) {
        self.begin = begin
        self.end = end
    ...
    public init(from decoder: Decoder) throws {
        ...
        hardness = try container.decode(CGFloat.self, forKey: .hardness)
